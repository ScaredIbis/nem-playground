...
const { NetworkCurrencyMosaic, TransferTransaction, NetworkType,
  EncryptedMessage, Deadline, Address, UInt64, PublicAccount} = require("nem2-sdk");
...
console.log("NETWORK CURRENCY", networkCurrency.id.toDTO());

const mosaics = [networkCurrency];
const message = EncryptedMessage.create("Test Transfer", recipientPublicAccount, childAccount.privateKey, NetworkType.TEST_NET);
