...
const { Mosaic, NetworkType, NamespaceId, NamespaceRegistrationType,
  NamespaceRegistrationTransaction, Deadline, Address, UInt64, Bu } = require("nem2-sdk");
