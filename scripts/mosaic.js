...
const { MosaicNonce, MosaicSupplyChangeAction, MosaicFlags, MosaicDefinitionTransaction, MosaicSupplyChangeTransaction, MosaicId, MosaicNonceDto, NetworkType, NetworkCurrencyMosaic, PlainMessage, Deadline, Address, UInt64 } = require("nem2-sdk");
...
const signedTransaction = childAccount.sign(mosaicSupplyChangeTransaction, generationHash);

console.log('mosaicSupplyChangeTransaction', mosaicSupplyChangeTransaction.toJSON())
console.log('mosaicSupplyChangeTransaction serialized', mosaicSupplyChangeTransaction.serialize())
console.log('mosaicSupplyChangeTransaction signed', signedTransaction)
